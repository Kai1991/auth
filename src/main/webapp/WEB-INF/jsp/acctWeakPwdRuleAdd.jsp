		...
		<div class="mainpanel">
		    ...
		    <div class="contentpanel">
		        ...
		        <div class="panel-heading">
		          <h4 class="panel-title"><spring:message code="screen.weakpwdrule.index"/></h4>
		        </div>
		        ...
		        <div class="panel-footer">
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
						  <button type="button" class="btn btn-primary" onclick="weakPwdRuleSave()"><spring:message code="screen.useredit.submit"/></button>&nbsp;
