...
<head>
  ...
  <title><spring:message code="screen.index.accountkeymonitor" /></title>
					...
					<div
						...
						<div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12" ">
							...
							<div class="input-group-btn">
								<input type="text" class="form-control input-lg" id="belongto"
								placeholder='<spring:message code='screen.user.belong.to'/>'>
					          ...
					          <table class="table table-striped" id="table2">
					              <thead>
					                 <tr>
					                    ...
					                    <th><spring:message code="screen.user.belong.to"/></th>
...
<!-- js code -->
    ...
    var baiduBsSuggest = $("#search-text").bsSuggest({
        ...
        url: '${ctx}/accountKeyMonitor/searchInfo1?search=',	/*优先从url ajax 请求 json 帮助数据，注意最后一个参数为关键字请求参数*/
 ...
 // 点击搜索按钮--start
    ...
    function searchByCondtion() {
    	...
    	$.ajax({
    		type : "POST",
    		url : '${ctx}/accountKeyMonitor/addAccountKeyMonitor',
    		async : false,
    		data : {"usercode":usercode, "belongto":belongto},
    		dataType : "json",
	...
	function del(obj){
		...
		$.ajax({
			url: '${ctx}/accountKeyMonitor/deleteAccountKeyMonitor',
