					...
					<div class="panel panel-default">
				        <div class="panel-heading">
				          <div class="panel-btns">
				            <a href="${ctx}/touseradd" class="btn btn-white"><spring:message code="screen.index.add"/></a>
				          </div>
					          ...
					          <table class="table table-striped" id="table2">
					              <thead>
					                 <tr>
					                    ...
					                    <th><spring:message code="screen.index.employeestatu"/></th>
					              ...
					              <tbody>
					              	 <c:forEach var="employee" items="${employees}">
										<tr class="gradeA">
											...
											<td>
											<c:if test="${employee.enablestate=='2'}">
												<spring:message code="screen.index.message.employeestatus.validate"/>
											</c:if>
											<c:if test="${employee.enablestate=='3'}">
												<spring:message code="screen.index.message.employeestatus.unvalidate"/>
											</c:if>
											</td>
											<td>
												<a href="${ctx}/useredit?code=${employee.cn}"><i class="editrecord"></i></a>
												<a href="" class="delete-row"><i class="deleterecord"></i></a>
											</td>
										</tr>
									 </c:forEach>
					              </tbody>
