		...
		<div class="mainpanel">
		    ...
		    <div class="pageheader">
		      ...
		      <div class="breadcrumb-wrapper">
		        ...
		        <ol class="breadcrumb">
		          <li class="active"><spring:message code="screen.weakpwdcfg.index.title" /></li>
		        </ol>
		      </div>
		    </div>
		    ...
		    <div class="contentpanel">
		        ...
		        <div class="panel-heading">
		          <h4 class="panel-title"><spring:message code="screen.weakpwdcfg.index.title"/></h4>
		        </div>
		        <div class="panel-body panel-body-nopadding">
					<form class="form-horizontal form-bordered" action="${ctx}/acctWeakPwdCfg/weakPwdSave" method="post">
			            <div class="form-group">
								<label class="col-sm-3 control-label"><spring:message
										code="screen.weakpwdcfg.index.weakpwd" /></label>
								<div class="col-sm-6">
									<input type="text" name="weakpwd" id="weakpwd" maxlength="100"
										class="form-control" />
								</div>
						</div>
					</form>
		        ...
		        <div class="panel-footer">
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
						  <button type="button" class="btn btn-primary" onclick="weakPwdSave()"><spring:message code="screen.useredit.submit"/></button>&nbsp;
...
<script>
function weakPwdSave(){
	var weakpwd = $("#weakpwd").val();
	if (weakpwd == "" || weakpwd == ""){
		alert('<spring:message code="screen.weakpwdcfg.index.attnotnull"/>');
		return false;
	}
	
	$.ajax({
		url:"${ctx}/acctWeakPwdCfg/weakPwdSave",
		dataType:"text",
		type:"post",
		async : false,
		data:{
		...
		success:function(data){
			...
			window.location='${ctx}/acctWeakPwdCfg/index';
		},
