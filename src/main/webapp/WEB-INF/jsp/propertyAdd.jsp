							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-usermenu pull-right">
									<li><a href="${ctx}/logout"><i
										...
										<spring:message code="screen.common.logout" /></a></li>
								</ul>
							</div>
						</li>
						<li>
					...
					<div class="panel-body panel-body-nopadding">
						<form class="form-horizontal form-bordered"
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="key" maxlength="100" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label"><spring:message
								...
								<div class="col-sm-6">
									<input type="text" name="value" maxlength="255"  class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label"><spring:message
								...
								<div class="col-sm-6">
									<input type="text" name="comment" maxlength="255"  class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label"><spring:message
