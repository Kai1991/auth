...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"首页",sLast:"尾页",sNext:"下一页",sPrevious:"上一页"},
sEmptyTable:"无记录",sInfo:"当前显示_START_到_END_记录,共_TOTAL_记录",sInfoEmpty:"",sInfoFiltered:"(从_MAX_条记录中筛选)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"过滤:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"未匹配到记录"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
