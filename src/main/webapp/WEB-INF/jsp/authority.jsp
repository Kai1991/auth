		...
		<div class="mainpanel">
		    ...
		    <div class="headerbar">
		      ...
		      <a class="menutoggle"><i class="fa fa-bars"></i></a>
 		      ...
 		      <%--<form class="searchform" action="${ctx}/authority" method="post">
					               ...
					               <tbody>
					              	 <c:forEach var="employee" items="${employees}">
										<tr class="gradeA">
											...
											<td>
												<a id="${employee.uid}" href="javascript:void(0)" class="delete-row" onclick="del(this)"><i class="deleterecord"></i></a>
											</td>
											</td>
										</tr>
									 </c:forEach>
...
/* 		    jQuery('.delete-row').click(function(){
    ...
    function searchByCondtion() {
    	...
    	$.ajax({
    		type : "POST",
    		url : '${ctx}/authority/addAuthority',
    		async : false,
    		data : {
    			"uid" : uid
    		},
	...
	function del(obj){
		var uid = obj.id;
		$.ajax({
			url: '${ctx}/authority/deleteAuthority',
			data: {uid: uid},
			type: 'post',
